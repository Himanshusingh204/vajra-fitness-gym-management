...
5. Apply the database schema once, from your machine, pointed at the same
   `DATABASE_URL` you set on Vercel:
   ```bash
   cd backend
...
- [ ] For multi-instance scaling, point rate-limit state at Redis (currently in-memory).
